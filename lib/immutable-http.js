...
var Http = (function () {
  function Http() {
    ...
    var headers = arguments[2] === undefined ? new _Map() : arguments[2];
    var body = arguments[3] === undefined ? null : arguments[3];
    var responseType = arguments[4] === undefined ? null : arguments[4];
    var dynamicSegments = arguments[5] === undefined ? new _Map() : arguments[5];
    var queryParams = arguments[6] === undefined ? new _Map() : arguments[6];
  ...
  _createClass(Http, [{
    ...
    value: function withHeader(header, value) {
      var headers = new _Map(this.headers()).set(header, value);
    ...
    value: function withDynamicSegment(segment, value) {
      var dynamicSegments = new _Map(this.dynamicSegments()).set(segment, value);
    ...
    value: function withParam(name, value) {
      var queryParams = new _Map(this.queryParams()).set(name, value);
...
var validateHeaders = function validateHeaders(headers) {
  ...
  try {
    for (var _iterator = _getIterator(headers.entries()), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
var mixinDynamicSegmentsValues = function mixinDynamicSegmentsValues(url, dynamicSegments) {
  ...
  try {
    for (var _iterator2 = _getIterator(dynamicSegments.entries()), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
var addQueryParams = function addQueryParams(url, queryParams) {
  ...
  try {
    for (var _iterator3 = _getIterator(queryParams.entries()), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
var addHeaders = function addHeaders(xmlhttp, headers) {
  ...
  try {
    for (var _iterator4 = _getIterator(headers.entries()), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
